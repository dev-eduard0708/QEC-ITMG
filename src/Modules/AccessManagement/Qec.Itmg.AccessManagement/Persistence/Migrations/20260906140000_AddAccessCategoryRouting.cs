...
{
    [Microsoft.EntityFrameworkCore.Infrastructure.DbContext(typeof(AccessManagementDbContext))]
    [Migration("20260906140000_AddAccessCategoryRouting")]
    public partial class AddAccessCategoryRouting : Migration
    {
        ...
        {
            migrationBuilder.DropTable(name: "AccessCategoryParticipant", schema: "acc");
            migrationBuilder.DropTable(name: "AccessCaseRouteParticipant", schema: "acc");
            migrationBuilder.DropTable(name: "AccessCategory", schema: "acc");

            migrationBuilder.DropIndex(name: "IX_AccessCase_AccessCategoryId", schema: "acc", table: "AccessCase");

            migrationBuilder.DropColumn(name: "AccessCategoryId", schema: "acc", table: "AccessCase");
            migrationBuilder.DropColumn(name: "AccessCategoryKeySnapshot", schema: "acc", table: "AccessCase");
            migrationBuilder.DropColumn(name: "AccessCategoryNameSnapshot", schema: "acc", table: "AccessCase");
            migrationBuilder.DropColumn(name: "PreferSubjectEmployeeVerificationSnapshot", schema: "acc", table: "AccessCase");
            migrationBuilder.DropColumn(name: "ApprovedByUserId", schema: "acc", table: "AccessCase");
            migrationBuilder.DropColumn(name: "ApprovedAtUtc", schema: "acc", table: "AccessCase");
            migrationBuilder.DropColumn(name: "VerifiedByUserId", schema: "acc", table: "AccessCase");
            migrationBuilder.DropColumn(name: "VerifiedAtUtc", schema: "acc", table: "AccessCase");
            migrationBuilder.DropColumn(name: "VerificationMethod", schema: "acc", table: "AccessCase");
            migrationBuilder.DropColumn(name: "VerificationOutcome", schema: "acc", table: "AccessCase");
            migrationBuilder.DropColumn(name: "VerificationComment", schema: "acc", table: "AccessCase");
            migrationBuilder.DropColumn(name: "FallbackReason", schema: "acc", table: "AccessCase");
            migrationBuilder.DropColumn(name: "ClosedByUserId", schema: "acc", table: "AccessCase");
        }
    }
}
