...
public static class IdentitySeedCatalog
{
    ...
    [
        ...
        ("organization.hierarchy.read", "View organization position hierarchy"),
        ...
        ("sec.awareness.read", "View security awareness campaigns and configuration"),
        ("sec.awareness.manage", "Manage security awareness modules, campaigns, and completion exports"),
        ("sec.awareness.report", "View security awareness completion reports and exports"),
