...
namespace Qec.Itmg.DocumentManagement.Persistence.Migrations
{
    ...
    [Migration("20260905154228_AddPolicyWorkflowResponsibilities")]
    partial class AddPolicyWorkflowResponsibilities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Qec.Itmg.DocumentManagement.Domain.ManagedDocument", b =>
                {
                    ...
                    b.Property<bool>("RequireReAcknowledgement")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Qec.Itmg.DocumentManagement.Domain.PolicyAcknowledgement", b =>
                {
                    ...
                    b.Property<string>("PolicyTitleSnapshot")
                        .HasMaxLength(512)
                        .HasColumnType("nvarchar(512)");
                    ...
                    b.HasIndex("AcknowledgedAtUtc")
                        .HasDatabaseName("IX_PolicyAcknowledgement_AcknowledgedAtUtc");
            ...
            modelBuilder.Entity("Qec.Itmg.DocumentManagement.Domain.PolicyAcknowledgementReminderLog", b =>
                {
                    ...
                    b.HasIndex("PolicyAssignmentId", "UserId", "ReminderKind")
                        .IsUnique()
                        .HasDatabaseName("IX_PolicyAckReminder_Assignment_User_Kind");

                    b.ToTable("PolicyAcknowledgementReminderLog", "doc");
                });

            modelBuilder.Entity("Qec.Itmg.DocumentManagement.Domain.PolicyAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DocumentVersionId")
                        .HasDatabaseName("IX_PolicyAssignment_DocumentVersionId");

                    b.HasIndex("DueAtUtc")
                        .HasDatabaseName("IX_PolicyAssignment_DueAtUtc");

                    b.HasIndex("UserId", "DocumentVersionId")
                        .HasDatabaseName("IX_PolicyAssignment_User_Version");

                    b.HasIndex("ManagedDocumentId", "DocumentVersionId", "AssignmentScope", "UserId")
                        .IsUnique()
                        .HasDatabaseName("IX_PolicyAssignment_Doc_Version_Scope_User")
                        .HasFilter("[UserId] IS NOT NULL");

                    b.ToTable("PolicyAssignment", "doc");
                });
