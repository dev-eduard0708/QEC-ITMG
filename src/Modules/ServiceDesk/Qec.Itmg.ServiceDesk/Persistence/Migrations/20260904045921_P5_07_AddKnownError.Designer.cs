...
namespace Qec.Itmg.ServiceDesk.Persistence.Migrations
{
    ...
    [Migration("20260904045921_P5_07_AddKnownError")]
    partial class P5_07_AddKnownError
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Qec.Itmg.ServiceDesk.Domain.Problem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset?>("KnownErrorAtUtc")
                        .HasColumnType("datetimeoffset");

                    b.Property<Guid?>("KnownErrorByUserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Problem", "sd");
                });

            modelBuilder.Entity("Qec.Itmg.ServiceDesk.Domain.ProblemIncident", b =>
                {
                    b.Property<Guid>("ProblemId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("IncidentTicketId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Qec.Itmg.ServiceDesk.Domain.ProblemIncident", b =>
                {
                    b.HasOne("Qec.Itmg.ServiceDesk.Domain.Ticket", null)
                        .WithMany()
                        .HasForeignKey("IncidentTicketId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Qec.Itmg.ServiceDesk.Domain.Problem", null)
                        .WithMany()
