...
Administration UI includes **QEC Hierarchy** (`/administration/hierarchy`; legacy IT Hierarchy route redirects) for company departments, membership, people, and position trees. See [ORGANIZATION.md](ORGANIZATION.md).
