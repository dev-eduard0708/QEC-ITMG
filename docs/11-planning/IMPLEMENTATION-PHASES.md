...
| P8-03 | Backup/restore test records | Done |
| P8-04 | Certificates expiry notify | Done |
| P8-05 | Patch metadata | Done |
| P8-06 | Jobs metadata | Done |
| P8-07 | Retention | Done |
| P8-08 | UI | Done |
| P8-09 | Permissions | Done |
| P8-10 | Tests | Deferred ? dedicated project testing phase |

**Phase 8:** FEATURE COMPLETE. VALIDATION/HARDENING DEFERRED (P8-10).

**NEXT:** P9 Access Management / JML.
