...
| Remote support | Attended/unattended session governance, engine integration | [REMOTE-SUPPORT.md](../03-modules/REMOTE-SUPPORT.md) |
| Assets / CMDB | Financial assets and operational CIs, relationships, history | [ASSET-CMDB.md](../03-modules/ASSET-CMDB.md) |
...
| Governance | Org, registers, diagrams, interfaces, control framework hosting | [GOVERNANCE.md](../03-modules/GOVERNANCE.md) |
...
| Audit | Internal/external audits, findings, CAPA, export | [AUDIT-MANAGEMENT.md](../03-modules/AUDIT-MANAGEMENT.md) |
...
| AI (future) | Assistive, authorization-bound | [../11-planning/MASTER-ROADMAP.md](../11-planning/MASTER-ROADMAP.md) |
